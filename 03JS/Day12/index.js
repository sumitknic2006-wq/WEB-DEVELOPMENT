...
/* forEach:- first element mandatry hai , second , third optional me hota hai. */
...
// // uper wale product ka name and price select kiye hai.
...
/* Data Structure: set , has:- isme koi particular value persent hai ya nahi. */
...
// s1.add(11);
// // console.log(s1.has(20));   //  has():- particular value persent hai ya nahi.

// s1.delete(10);
// console.log(s1);
// // s1.clear();  // jitna s1 me value hai sab delete ho jayega.
// console.log(s1.size);
...
/* Map:- value ko key vlue pair me store karta hai but key object or array or kuch bhi ho sakti hai.   */
...
console.log(m1.get("Rohit"));  // get: "Rohit" ke corresponding kon si value persent hai.
